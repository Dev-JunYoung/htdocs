...
<html lang="en">
  <head>
    ...
    <!-- Favicons<link rel="apple-touch-icon" href="/docs/5.2/assets/img/favicons/apple-touch-icon.png" sizes="180x180">
...
<link rel="stylesheet" href="css/style.css">
  ...
  <div class="wrapper">
    ...
    <div class="center">
      ...
      <br>
        <input type="text" width="40px" class="form-control" placeholder="제목을 입력해 주세요." name="name" ></input>
        ...
        <button style="margin-left:1000px" type="button" class="btn btn-success" onclick="location.href=''" >등록</button>
